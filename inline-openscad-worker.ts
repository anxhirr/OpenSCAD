const [workerJsFile, openscadEmscriptenJsFile, outputFile, deploymentUrl] =
  Deno.args;
console.log(`
...
${openscadEmscriptenJs
  .replaceAll(/import.meta.url/g, "import_meta_url")
  .replaceAll(/export default OpenSCAD;/g, "")}
